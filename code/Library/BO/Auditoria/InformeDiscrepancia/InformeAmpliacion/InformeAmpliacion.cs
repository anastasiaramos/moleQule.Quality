...
{
	[Serializable()]
	public class InformeAmpliacionRecord : RecordBase
	{
		#region Attributes
		...
		public virtual bool Valorado { get { return _valorado; } set { _valorado = value; } }
		...
		public InformeAmpliacionRecord(){}
		...
		public virtual void CopyValues(IDataReader source)
		{
			...
			_valorado = Format.DataReader.GetBool(source, "VALORADO");
		...
		public virtual void CopyValues(InformeAmpliacionRecord source)
		{
			if (source == null) return;
    ...
    [Serializable()]
	public class InformeAmpliacionBase 
	{	 
		#region Attributes
		
		private InformeAmpliacionRecord _record = new InformeAmpliacionRecord();
		
		#endregion
		
		#region Properties
		
		public InformeAmpliacionRecord Record { get { return _record; } }
		...
		public void CopyValues(InformeAmpliacionInfo source)
		{
			if (source == null) return;
	...
	/// </summary>	
    [Serializable()]
	public class InformeAmpliacion : BusinessBaseEx<InformeAmpliacion>
	{	 
		#region Attributes
		...
		public virtual bool Valorado
		{
			[System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)]
			get
			{
				//CanReadProperty(true);
				return _base.Record.Valorado;
			}
			...
			set
			{
				...
				if (!_base.Record.Valorado.Equals(value))
				{
					_base.Record.Valorado = value;
					PropertyHasChanged();
				}
			}
		}
        ...
        {
            get { return base.IsValid && _ampliaciones.IsValid && _notificaciones.IsValid; }
        }

        public override bool IsDirty
        {
            get { return base.IsDirty || _ampliaciones.IsDirty || _notificaciones.IsDirty; }
        }
		...
		public virtual InformeAmpliacion CloneAsNew()
		{
			InformeAmpliacion clon = base.Clone();
			...
			clon.SessionCode = InformeAmpliacion.OpenSession();
			InformeAmpliacion.BeginTransaction(clon.SessionCode);
		...
		protected virtual void CopyFrom(InformeAmpliacionInfo source)
		{
			if (source == null) return;
        ...
        {
            Serial = SerialInformeAmpliacionInfo.GetNext(oid);
            Codigo = Serial.ToString(Resources.Defaults.INFORME_AMPLIACION_CODE_FORMAT);
        }
        ...
        public virtual InformeAmpliacionInfo GetInfo(bool get_childs)
        {
            if (!CanGetObject())
                throw new System.Security.SecurityException(
                    moleQule.Library.Resources.Messages.USER_NOT_ALLOWED);

            return new InformeAmpliacionInfo(this, get_childs);
            ...
            if (get_childs)
            {
                ...
                {
                    string query = Ampliaciones.SELECT_BY_FIELD( "OidInformeAmpliacion", this.Oid);
                    IDataReader r_ampliaciones = nHManager.Instance.SQLNativeSelect(query, Session());

                    return new InformeAmpliacionInfo(
                    _oid, _oid_informe_discrepancia, _codigo, _serial, _fecha, _numero, _observaciones, AmpliacionList.GetChildList(r_ampliaciones));
                }
                else
                    return new InformeAmpliacionInfo(_oid, _oid_informe_discrepancia, _codigo, _serial, _fecha, _numero, _observaciones,AmpliacionList.GetChildList(_ampliaciones));
            }
            else
                return new InformeAmpliacionInfo(_oid, _oid_informe_discrepancia, _codigo, _serial, _fecha, _numero, _observaciones, null);*/
        }

        public virtual InformeAmpliacionInfo GetInfo()
        {
            return GetInfo(true);
        }
        ...
        public static InformeAmpliacion New()
        {
            if (!CanAddObject())
                throw new System.Security.SecurityException(
                  moleQule.Library.Resources.Messages.USER_NOT_ALLOWED);

            return DataPortal.Create<InformeAmpliacion>(new CriteriaCs(-1));
        }
        ...
        public static InformeAmpliacion Get(CriteriaEx criteria)
        {
            if (!CanGetObject())
                throw new System.Security.SecurityException(
                  moleQule.Library.Resources.Messages.USER_NOT_ALLOWED);
        ...
        /// <summary>
        /// Elimina todas los InformeAmpliacions
        /// </summary>
        public static void DeleteAll()
        {
            //Iniciamos la conexion y la transaccion
            int sessCode = InformeAmpliacion.OpenSession();
            ISession sess = InformeAmpliacion.Session(sessCode);
            ITransaction trans = InformeAmpliacion.BeginTransaction(sessCode);

            try
            {
                sess.Delete("from InformeAmpliacion");
                trans.Commit();
            }
            catch (Exception ex)
            {
            ...
            {
                InformeAmpliacion.CloseSession(sessCode);
            }
        }

        public override InformeAmpliacion Save()
        {
        ...
        private InformeAmpliacion(InformeAmpliacion source)
        {
            MarkAsChild();
            Fetch(source);
        }

        private InformeAmpliacion(int session_code, IDataReader reader, bool childs)
        {
            MarkAsChild();
            Childs = childs;
        ...
        internal static InformeAmpliacion GetChild(InformeAmpliacion source)
        {
            return new InformeAmpliacion(source);
        }

        internal static InformeAmpliacion GetChild(int session_code, IDataReader reader, bool childs)
        {
            return new InformeAmpliacion(session_code, reader, childs);
        }


        internal static InformeAmpliacion GetChild(int session_code, IDataReader reader)
        {
        ...
        internal void Update(InformeDiscrepancia parent)
        {
            ...
            try
            {
                ...
                InformeAmpliacionRecord obj = parent.Session().Get<InformeAmpliacionRecord>(Oid);
        ...
        protected override void DataPortal_Update()
        {
            if (IsDirty)
            {
                try
                {
                    InformeAmpliacionRecord obj = Session().Get<InformeAmpliacionRecord>(Oid);
                    obj.CopyValues(this.Base.Record);
                    Session().Update(obj);
                }
                catch (Exception ex)
        ...
        private void DataPortal_Delete(CriteriaCs criterio)
        {
            try
            {
                ...
                // Obtenemos el objeto
                InformeAmpliacionRecord obj = (InformeAmpliacionRecord)(criteria.UniqueResult());
                Session().Delete(Session().Get<InformeAmpliacionRecord>(obj.Oid));
        ...
        internal static string JOIN()
        {
            ...
            string ia = nHManager.Instance.GetSQLTable(typeof(InformeAmpliacionRecord));
        ...
        internal static string WHERE(QueryConditions conditions)
        {
            ...
            if (conditions.InformeDiscrepancia != null && conditions.InformeDiscrepancia.Oid > 0)
                query += " AND IA.\"OID_INFORME_DISCREPANCIA\" = " + conditions.InformeDiscrepancia.Oid;
        ...
        internal static string SELECT(QueryConditions conditions, bool lockTable)
        {
            ...
            query = SELECT_FIELDS() +
                    JOIN() +
                    WHERE(conditions) +
                    " ORDER BY IA.\"FECHA_CREACION\"";

            if (lockTable) query += " FOR UPDATE OF IA NOWAIT";
