...
{
    public partial class ClaseAuditoriaMngForm : Skin02.EntityLMngSkinForm
    {
        ...
        private new SortedBindingList<ClaseAuditoriaInfo> _filter_results = null;
        private new SortedBindingList<ClaseAuditoriaInfo> _sorted_list = null;
        private new SortedBindingList<ClaseAuditoriaInfo> _search_results = null;

        /// <summary>
        ///  Lista de objetos de sólo lectura
        /// </summary>
        internal new ClaseAuditoriaList List
        {
            get { return _item_list as ClaseAuditoriaList; }
            set { _item_list = value; _sorted_list = (value as ClaseAuditoriaList).GetSortedList(); }
        }
        internal new SortedBindingList<ClaseAuditoriaInfo> SortedList { get { return _sorted_list; } }
        internal new ClaseAuditoriaList FilteredList { get { return ClaseAuditoriaList.GetList(_filter_results); } }
        internal SortedBindingList<ClaseAuditoriaInfo> CurrentList { get { return (Datos.List as SortedBindingList<ClaseAuditoriaInfo>); } }

		/// <summary>
		/// Devuelve el OID del objeto activo seleccionado de la tabla
		/// </summary>
		/// <returns></returns>
		public override long ActiveOID { get { return Datos.Current != null ? ((ClaseAuditoriaInfo)Datos.Current).Oid : -1; } }

        /// <summary>
        /// Devuelve el objeto activo seleccionado de la tabla
        /// </summary>
        /// <returns></returns>
        public ClaseAuditoriaInfo ActiveItem { get { return (Datos.Current != null) ? (ClaseAuditoriaInfo)Datos.Current : null; } }
		
        public override long ActiveFoundOID { get { return (DatosSearch.Current != null) ? ((ClaseAuditoriaInfo)(DatosSearch.Current)).Oid : -1; } }
		...
		public ClaseAuditoriaMngForm()
            : this(false) {}

		public ClaseAuditoriaMngForm(bool isModal)
			: this(isModal, null) {}

        public ClaseAuditoriaMngForm(Form Parent)
            : this(false, Parent) { }
		
		public ClaseAuditoriaMngForm(bool isModal, Form Parent)
			: base(isModal, Parent)
		{
            InitializeComponent();
		...
		{
			Bar.Grow(string.Empty, "ClaseAuditoria");
