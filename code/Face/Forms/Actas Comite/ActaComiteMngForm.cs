...
{
    public partial class ActaComiteMngForm : ActaComiteMngBaseForm
    {
        ...
        public ActaComiteMngForm() : this(false, null) { }

        public ActaComiteMngForm(Form parent) : this(false, parent) { }

        public ActaComiteMngForm(bool isModal, Form parent) : this(isModal, parent, null) { }

        public ActaComiteMngForm(bool isModal, Form parent, ActaComiteList list)
            : base(isModal, parent, list)
        {
            ...
            Datos.DataSource = ActaComiteList.NewList().GetSortedList();

            base.SortProperty = Codigo.DataPropertyName;

            this.Text = Resources.Labels.ACTA_COMITE;
        }
        ...
        {
            PgMng.Grow(string.Empty, "ActaComite");
            ...
            PgMng.Grow(string.Empty, "Lista de ActaComites");
        }
        ...
        protected new SortedBindingList<ActaComiteInfo> Localize(FilterItem item)
        {
    ...
    public partial class ActaComiteMngBaseForm : Skin06.EntityMngSkinForm<ActaComiteList, ActaComiteInfo>
    {
        public ActaComiteMngBaseForm()
            : this(false, null, null) { }

        public ActaComiteMngBaseForm(bool isModal, Form parent, ActaComiteList lista)
