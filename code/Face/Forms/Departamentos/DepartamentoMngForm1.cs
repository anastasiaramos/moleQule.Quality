...
{
    public partial class DepartamentoMngForm : Skin02.EntityLMngSkinForm
    {
        ...
        private new SortedBindingList<DepartamentoInfo> _filter_results = null;
        private new SortedBindingList<DepartamentoInfo> _sorted_list = null;
        private new SortedBindingList<DepartamentoInfo> _search_results = null;

        /// <summary>
        ///  Lista de objetos de sólo lectura
        /// </summary>
        internal new DepartamentoList List
        {
            get { return _item_list as DepartamentoList; }
            set { _item_list = value; _sorted_list = (value as DepartamentoList).GetSortedList(); }
        }
        internal new SortedBindingList<DepartamentoInfo> SortedList { get { return _sorted_list; } }
        internal new DepartamentoList FilteredList { get { return DepartamentoList.GetList(_filter_results); }}
        internal SortedBindingList<DepartamentoInfo> CurrentList { get { return (Datos.List as SortedBindingList<DepartamentoInfo>); } } 

		/// <summary>
		/// Devuelve el OID del objeto activo seleccionado de la tabla
		/// </summary>
		/// <returns></returns>
		public override long ActiveOID { get { return Datos.Current != null ? ((DepartamentoInfo)Datos.Current).Oid : -1; } }

        /// <summary>
        /// Devuelve el objeto activo seleccionado de la tabla
        /// </summary>
        /// <returns></returns>
        public DepartamentoInfo ActiveItem { get { return (Datos.Current != null) ? (DepartamentoInfo)Datos.Current : null; } }
		
        public override long ActiveFoundOID { get { return (DatosSearch.Current != null) ? ((DepartamentoInfo)(DatosSearch.Current)).Oid : -1; } }
		...
		public DepartamentoMngForm()
            : this(false) {}

		public DepartamentoMngForm(bool isModal)
            : this(isModal, null) { }

        public DepartamentoMngForm(Form parent)
            : this(false, parent) { }
		
		public DepartamentoMngForm(bool isModal, Form Parent)
			: base(isModal, Parent)
		{
            InitializeComponent();
		...
		{
			Bar.Grow(string.Empty, "Departamento");
        ...
        protected new SortedBindingList<DepartamentoInfo> Localize(object value, string column_name)
        {
